...
### New Vault
If you don't have an existing Vault, [download Obsidian](https://obsidian.md/) and create a new Vault in the `/content` folder that you created and cloned during the [setup](private/setup/setup.md) step.
...
![Obsidian Settings](images/obsidian-settings.png)*Obsidian Settings*
